...
Cómo Funciona
Seleccionar la moneda base: Se pide al usuario que introduzca el número correspondiente a la moneda base para la conversión.
Seleccionar la moneda de destino: Se solicita al usuario que introduzca el número correspondiente a la moneda de destino.
Ingresar el valor de la moneda base: Finalmente, el usuario introduce el valor de la moneda base que desea convertir.
Realizar la conversión: El programa utiliza la API de ExchangeRate para obtener la tasa de cambio y realiza la conversión, mostrando el resultado.
